...
public final class EdgeEffectCompat {
     ...
     * returns true and draw the results accordingly.
     *
     * Views using {@link EdgeEffect} should favor {@link EdgeEffect#onPull(float)} when
     ...
     *                     Values may be from 0-1.
     *
     * @see {@link EdgeEffect#onPull(float)}
     */
    public static void onPull(EdgeEffect edgeEffect, float deltaDistance,
                              float displacement) {
